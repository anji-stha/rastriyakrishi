                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="share" name="share"
                                placeholder="Shares" value="{{ $user->investmentDetailsById ? $user->investmentDetailsById->share : '' }}" readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="investment_amount" name="investment_amount"
                                placeholder="Amount" value="{{ $user->investmentDetailsById ? $user->investmentDetailsById->investment_amount : '' }}"
                                readonly>
                        </div>
                    </div>
                    <div class="col-md-4">
                ...
                <div class="form-group">
                    <label class="form-check-label" for="terms_conditions">
                        ...
                        <ul>
                            ...
                            <li>३. लगानीकर्ताले कम्पनीद्वारा तोकिएका तथा समय समयमा तोकिने सबै नियम र शर्तहरू पालना गर्न सहमत
                                हुनुपर्दछ।</li>
                        ...
                        <p><strong>नोट:</strong> कम्पनीको सम्बन्धमा कुनै जानकारी चाहियमा वा सम्पर्क गर्नुपरेमा कम्पनीको ईमेल
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="checkbox" id="terms_conditions" name="terms_conditions"
                            {{ $user->terms_conditions ? 'checked' : '' }} disabled>
                        <label class="form-check-label" for="terms_conditions">
                            I Agree
                        </label>
                    </div>
