...
<div class="footer mt-5">
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <ul class="list-unstyled footer-links">
                    <li><a href="{{ route('brochure.public.index') }}" target="_blank">Brochure</a></li>
                </ul>
            </div>
            <div class="col-md-3">
        ...
        <div class="text-center">
            ...
            <br>
            <small>Crafted By: <a href="https://www.arkbotech.com/" target="_blank">ARKBO Technologies</a></small>
        </div>
    </div>
</div>
